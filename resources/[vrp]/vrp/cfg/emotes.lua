...
--  ["Plantar"] = {false, {task="WORLD_HUMAN_GARDENER_PLANT"}, false},
  ["Ficar de Guarda"] = {false, {task="WORLD_HUMAN_GUARD_STAND"}, false},
--  ["Martelo"] = {false, {task="WORLD_HUMAN_HAMMERING"}, false},
--  ["Sair para curtir"] = {false, {task="WORLD_HUMAN_HANG_OUT_STREET"}, false},
...
--  ["Peixe"] = {false, {task="WORLD_HUMAN_STAND_FISHING"}, false},
