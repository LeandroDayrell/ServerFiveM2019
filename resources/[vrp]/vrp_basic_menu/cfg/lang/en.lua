...
local lang = {
	...
	inspect = {
		button = "Inspection",
		perm = "player.inspect",
		desc = "Inspecionar inventario do jogador.",
	},
	jail = {
		button = "Jail ADD",
		perm = "police.bmjail",
	...
	mpay = {
		button = "Aplicativo PAGSEGURO",
		perm = "mobile.pay",
		desc = "Você pode transferir o dinheiro de sua mão para outro jogador",
