...
RegisterNetEvent('sendadmMessage')
AddEventHandler('sendadmMessage', function(id, name, message)
	TriggerEvent('chatMessage', "[AVISO] Server"..name, {255, 193, 37}, message)
end)
...
RegisterNetEvent('sendfacebookMessage')
AddEventHandler('sendfacebookMessage', function(id, name, message)
	TriggerEvent('chatMessage', "[Facebook]"..name, {100, 149, 237}, message)
end)
