...
function Chat(t)
	TriggerEvent("chatMessage", 'caminhoneiro', { 0, 255, 255}, "" .. tostring(t))
end

--locations
--arrays
local TruckingCompany = {}
TruckingCompany[0] = {["x"] = -338.71408081054,["y"] = -1023.0214233398, ["z"] = 30.384769439698}    
local TruckingTrailer = {}
TruckingTrailer[0] = {["x"] = -323.37670898438, ["y"] = -1010.7572631836, ["z"] = 30.385082244874} 
...
local MissionData = {
    ...
    [1] = {2574.5144, 328.5554, 108.45, 1000},
    [2] = {-2565.0894, 2345.8904, 33.06, 1500},
    [3] = {1706.7966, 4943.9897, 42.16, 2000},
    [4] = {196.5617, 6631.0967, 31.53, 3000},
...
function tick()
    ...
    elseif( MISSION.start == true ) then
        ...
        if( IsEntityAttached(MISSION.trailer) and text1 == false) then
            TriggerEvent("mt:missiontext", "Drive to the marked ~g~destination~w~.", 1000)
            text1 = true
        elseif( not IsEntityAttached(MISSION.trailer) and text2 == false ) then
            TriggerEvent("mt:missiontext", "Attach the ~o~trailer~w~.", 1500)
            text2 = true
        end
        Wait(2000)
        ...
        if ( GetDistanceBetweenCoords(currentMission[1], currentMission[2], currentMission[3], trailerCoords ) < 25 and  not IsEntityAttached(MISSION.trailer)) then
            TriggerEvent("mt:missiontext", "You gained $"..currentMission[4], 500)
        ...
        elseif ( GetDistanceBetweenCoords(currentMission[1], currentMission[2], currentMission[3], trailerCoords ) < 25 and IsEntityAttached(MISSION.trailer) ) then
            TriggerEvent("mt:missiontext", "Arrived. Detach your ~o~trailer~w~ with ~r~H~w~", 1500)
        end
...
function GUI.init()
    GUI.loaded = true
    GUI.addTitle("You're a trucker now.",-297.43304443359,-1012.7732543945,30.379808425903 )
    GUI.addDesc("Choose a trailer.", -297.43304443359,-1012.7732543945,30.379808425903 )

    --menu, title, function, position
    GUI.addButton(0, "RON Tanker trailer", GUI.optionMisson, -297.43304443359,-1012.7732543945,30.379808425903 )
    GUI.addButton(0, "Container trailer", GUI.optionMisson, -297.43304443359,-1012.7732543945,30.379808425903 )
    GUI.addButton(0, "Articulated trailer", GUI.optionMisson, -297.43304443359,-1012.7732543945,30.379808425903 )
    GUI.addButton(0, "Log trailer", GUI.optionMisson, -297.43304443359,-1012.7732543945,30.379808425903 )
    GUI.addButton(0, " ", GUI.null, -297.43304443359,-1012.7732543945,30.379808425903)
    GUI.addButton(0, "Exit Menu", GUI.exit, -297.43304443359,-1012.7732543945,30.379808425903 )
    
    GUI.buttonCount = 0
    
    GUI.addButton(1, "Mission 1 [ 1.000$ ]", GUI.mission, -297.43304443359,-1012.7732543945,30.379808425903)
    GUI.addButton(1, "Mission 2 [ 2.000$ ]", GUI.mission, -297.43304443359,-1012.7732543945,30.379808425903)
    GUI.addButton(1, "Mission 3 [ 3.000$ ]", GUI.mission, -297.43304443359,-1012.7732543945,30.379808425903)
    GUI.addButton(1, "Mission 4 [ 4.000$ ]", GUI.mission, -297.43304443359,-1012.7732543945,30.379808425903)
    GUI.addButton(1, "Mission 5 [ 5.000$ ]", GUI.mission, -297.43304443359,-1012.7732543945,30.379808425903)
    GUI.addButton(1, "For Testing! [ 1.000$ ]", GUI.mission, -297.43304443359,-1012.7732543945,30.379808425903)
    GUI.addButton(1, "Exit Menu", GUI.exit, -297.43304443359,-1012.7732543945,30.379808425903)
end
