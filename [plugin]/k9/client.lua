...
--[[ Main Event Handlers ]]--
    ...
    AddEventHandler("K9:OpenMenu", function(pedRestriction, pedList)
        if pedRestriction then
            if CheckPedRestriction(GetLocalPed(), pedList) then
                ...
                Notification(tostring("~r~Você  tem que ta com o uniforme pra usa o cachorro."))
            end
        else
            EnableMenu()
        end
    ...
    AddEventHandler("K9:IdentifierRestricted", function()
        Notification(tostring("~r~Você não ta na lista."))
    end)
    ...
    AddEventHandler("K9:SearchVehicle", function(items, openDoors)
        ...
        if vehicle ~= 0 and not searching then
            ...
            Notification(tostring(k9_name .. " começou a pesquisar ..."))
            ...
            Notification(tostring(k9_name .. " encontrou [ " .. tostring(table.concat(stringified_table, ", ")) .. " ]."))
            searching = false
        end
    end)
