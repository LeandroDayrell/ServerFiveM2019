...
animal_models = {'a_c_chickenhawk','a_c_chimp','a_c_cormorant','a_c_cow','a_c_coyote','a_c_crow','a_c_hen','a_c_deer','a_c_fish','a_c_seagull','a_c_pig','a_c_pigeon','a_c_rat'}
...
mp_models = {'mp_f_deadhooker','mp_f_misty_01','mp_f_stripperlite','mp_g_m_pros_01','mp_m_claude_01','mp_m_exarmy_01','mp_m_famdd_01','mp_m_fibsec_01','mp_m_marston_01','mp_m_niko_01','mp_m_shopkeep_01','mp_s_m_armoured_01'}
freemode_models = {'mp_m_freemode_01','mp_f_freemode_01'}
menu_options = {
    {name = "Roupas", f = customise, param = nil},
    {name = "Acessórios", f = accessories, param = nil},
    {name = "Cara", f = overlays, param = nil},
    {name = "Modelos masculinos", f = listModels, param = male_models},
    {name = "Modelos femininos", f = listModels, param = female_models},
  --{name = "Modelos de animais", f = listModels, param = animal_models},
    --{name = "Modelos EMS", f = listModels, param = ems_models},
    {name = "Modelos multiplayer", f = listModels, param = mp_models},
    {name = "Modelos Freemode", f = listModels, param = freemode_models},
}
player_data  = {
...
local clothing_shops = {
    {name="Loja de roupas", id=73, x=1932.76989746094, y=3727.73510742188, z=32.8444557189941},
    {name="Loja de roupas", id=73, x=1693.26, y=4822.27, z=42.06},
    {name="Loja de roupas", id=73, x=125.83, y=-223.16, z=54.55},
    {name="Loja de roupas", id=73, x=-710.16, y=-153.26, z=37.41},
            ...
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                ...
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    if (incircle == false) then
                        DisplayHelpText("pressione ~INPUT_CONTEXT~ para personalizar seu personagem")
                    end
                    incircle = true
