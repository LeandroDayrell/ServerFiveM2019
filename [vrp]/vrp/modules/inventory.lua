      ...
      if not chests[name] then
        ...
        local cb_take = function(idname)
          ...
          if amount >= 0 and amount <= citem.amount then
            ...
            if new_weight <= vRP.getInventoryMaxWeight(user_id) then
              ...
              TriggerClientEvent("pNotify:SendNotification",player,{text = "<span color='red'>Inventario Cheio</span>", type = "info", timeout = (3000),layout = "centerLeft"})
            end
          else
            TriggerClientEvent("pNotify:SendNotification",player,{text = "<span color='red'>Valor inválido</span>", type = "error", timeout = (3000),layout = "centerLeft"})
          end
        ...
        local cb_put = function(idname)
          ...
          if new_weight <= max_weight then
            ...
            TriggerClientEvent("pNotify:SendNotification",player,{text = "<span color='red'>Bau Cheio</span>", type = "info", timeout = (3000),layout = "centerLeft"})
          end
        end
        ...
        TriggerClientEvent("pNotify:SendNotification",player,{text = "<span color='red'>Este Bau ja foi Aberto por outra pessoa.</span>", type = "info", timeout = (3000),layout = "centerLeft"})
      end
    end
  end
end
