...
local lang = {
  common = {
    welcome = "Bem vindo. Use a tecla M para usar o menu de Interação de Jogador.",
  ...
  dinheirosujo = {
    ...
    paid = "Pago ~r~{1}$.",
    give = {
      title = "Enviar dinheiro sujo",
      description = "Enviar dinheiro sujo ao jogador mais proximo de voce.",
      prompt = "Quantidade para enviar:"
    }
  },
  ...
  atm = {
   ...
   atmdinheirosujo = {
    display = "<span class=\"symbol\">ß</span> {1}",
	title = "Caixa da Favela",
    info = {
      title = "Saldo",
      bank = "buraco: {1} $"
    },
    deposit = {
      title = "Mocar dinheiro no buraco",
      description = "Colocar dinheiro no buraco",
      prompt = "Insira a quantidade que você quer depositar:",
      deposited = "~r~{1}$~s~ depositado."
    },
    withdraw = {
      title = "Tirar o dinheiro",
      description = "retirar para sua carteira",
      prompt = "Insira a quantidade que você quer retirar:",
      withdrawn = "~g~{1}$ ~s~retirado.",
      not_enough = "~r~Você não tem dinheiro suficiente no banco."
  ...
  police = {
    ...
    pc = {
      ...
      records = {
	   ...
	   licenca = {
        show = {
          title = "Vericar licenca de arma",
          description = "Mostrar lincenca de arma do jogador."
        },
        delete = {
          title = "Deletar licenca de arma",
          description = "Apagar a licenca de arma do jogador",
          deleted = "~b~Licenca excluido"
        }
      }
    },
    menu = {
	  ...
	  portamalas = {
		...
		description = "Abrir porta malas do jogador",
		abrir = "Abrindo porta malas",
		},
      putinveh = {
      ...
      check = {
        ...
        info = "<em>Dinheiro: </em>{1} $<br /><br /><em>Dinheiro Sujo: </em>{2}<br /><br /><em>inventario: </em>{3}<br /><br /><em>Armas: </em>{4}",
	  ...
	  licenca = {
        title = "Licenca",
        description = "Dari licenca para pessoa mais proxima.",
        licencad = "~b~Licencad ~s~{2} $ for ~b~{1}.",
        notify_licencad = "~b~You have been Licenca ~s~ {2} $ for ~b~{1}.",
        record = "[Licenca] {2} $ for {1}"
      },
      store_weapons = {
  ...
  itemtr = {
    not_enough_reagents = "~r~Não há reagentes suficientes.",
    informer = {
