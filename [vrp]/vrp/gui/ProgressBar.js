  ...
  if(anchor){
    ...
    if(anchor_index >= 0){
      if(anchor_name == "minimap"){ //MINIMAP
        ...
        //set size
        this.div.style.width = this.div_label.style.width = (135)+"px";
        ...
        this.div.style.top = (document.body.offsetHeight-170-anchor_index*15)+"px";
      }
        ...
        //set size
        this.div.style.width = this.div_label.style.width = (330)+"px";
        this.div_inner.style.height = this.div.style.height = this.div_label.style.height = (50)+"px";
        this.div_label.style.lineHeight = this.div_label.style.height;
        ...
        this.div.style.top = (document.body.offsetHeight-110-anchor_index*22)+"px";
      }
    }
  }
