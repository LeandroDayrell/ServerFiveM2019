                  ...
                  if has then
                    ...
                    if random == 3 or random == 7 or random == 11 or random == 5 then
                      ...
                      exports.pNotify:SendNotification({
                        text = "A pessoa rejeitou sua oferta",
                        type = "error",
...
while true do
  ...
  if selling then
    ...
    if distance > 6 then
      exports.pNotify:SetQueueMax("left", 1)
      exports.pNotify:SendNotification({
        text = "Venda cancelada: Voce esta longe agora.",
        type = "error",
        timeout = math.random(100, 3500),
        layout = "centerLeft",
        queue = "left"
    ...
    if rejected then
      drawTxt(0.90, 1.40, 1.0,1.0,0.4, "Pessoa ~r~rejeitado ~w~sua oferta ~r~", 255, 255, 255, 255)
    end
  end
  end)
