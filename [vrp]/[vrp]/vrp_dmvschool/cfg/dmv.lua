...
cfg.dmv = {
  ...
  menu = {
    ...
    font = 0,
    menu_title = "Detran",
    menu_subtitle = "CNH pra condução",
    color_r = 0,
    color_g = 128,
    color_b = 255,
  }
...
cfg.intro = {
  ...
  },
  {
    ...
    msg = "<b style='color:#1E90FF'>residencial</b> <br /><br /> Mantenha uma velocidade adequada - Nunca mais rápido do que o limite postado, mais lento se o tráfego for pesado.<br /><br />Fique centrado na sua pista. Nunca dirija na área reservada para carros estacionados.<br /><br />Mantenha uma distância segura seguinte - pelo menos 1 comprimento do carro por cada 20 kmh.<br /><br />O limite de velocidade em uma área residencial é de 50 km/h.<br />"
  },
  {
    pos = {246.35220336914, -1204.3403320313, 43.669715881348},
    msg = "<b style='color:#1E90FF'>Cidades</b> <br /><br />O limite de 80 km / h geralmente se aplica a todo o tráfego em todas as estradas com iluminação pública, a menos que especificado de outra forma.<br />Conduzir a velocidades muito rápidas para a estrada e as condições de condução podem ser perigosas.<br /><br />Você sempre deve reduzir sua velocidade quando:<br /><br />&bull; Compartilhando a estrada com pedestres<br />&bull; Dirigindo à noite, pois é mais difícil ver outros usuários da estrada<br />&bull; As condições meteorológicas tornam mais seguro fazê-lo<br /><br />Lembre-se, grandes veículos e motocicletas precisam de uma maior distância para parar<br />"
  },
  {
  ...
  },
  {
    ...
    msg = "<b style='color:#1E90FF'>Álcool</b> <br /><br />Beber ao dirigir é muito perigoso, álcool e/ou drogas prejudicam seu julgamento. O julgamento prejudicado afeta a forma como você reage aos sons e ao que vê. No entanto, o CNH permite uma certa quantidade de concentração de álcool para aqueles que dirigem com uma carteira de motorista válida.<br /><br />0,08% é o limite legal para a concentração de álcool no sangue de um motorista (BAC)<br />"
  },
}

cfg.practical = {
  intro = {
	  "<b style='color:#1E90FF'>Instrutor da CNH:</b> <br /><br /> Use o <b style='color:#DAA520'>Controle de cruzeiro</b> característica para evitar <b style='color:#87CEFA'>acelerando</b>, Ative isso durante o teste, pressionando o botão <b style='color:#20B2AA'>X</b> botão no seu teclado.<br /><br /><b style='color:#87CEFA'>Avaliação:</b><br />- Tente não bater o veículo ou passar pelo limite de velocidade publicado. Você receberá <b style='color:#A52A2A'>Pontos de erro</b> sempre que você não siga estas regras<br /><br />- Muitos <b style='color:#A52A2A'>Pontos de erro</b> acumulado resultará em <b style='color:#A52A2A'>Falhou</b> teste",
	 "<b style='color:#1E90FF'>Instrutor da CNH:</b> <br /><br /> Atualmente, estamos preparando seu veículo para o teste, enquanto você deve ler algumas linhas importantes.<br /><br /><b style='color:#87CEFA'>Speed limit:</b><br />- Preste atenção ao tráfego e fique sob o <b style='color:#A52A2A'>Rapidez</b> limite<br /><br />- Até agora, você deve saber o básico, no entanto, tentaremos lembrá-lo sempre que você <b style='color:#DAA520'>enter/exit</b> uma área com um limite de velocidade publicado",
  },
  max_errors = 5,
  ...
  steps = {
	...
	},
    {
	  ...
	  stop = "Faça um rápido ~r~stop~s~ para pedestres ~y~cruzando",
	  msg = "~g~Ótimo!~s~ Vamos continuar em movimento!"
	},
    {
	  pos = {217.82102966309,-1410.5201416016,28.292112350464},
	  stop = "Faça um rápido ~r~Pare~s~ e assista seu ~y~ESQUERDA~s~ antes de entrar no trânsito",
	  msg = "~g~Ótimo!~s~ agora tome uma ~y~CERTO~s~ e escolha sua pista",
	  area = 2
	},
    {
	  pos = {178.55052185059,-1401.7551269531,27.725154876709},
	  msg = "Assista ao trânsito ~y~luzes~s~ !"
	},
    {
	...
	},
    {
	  ...
	  msg = "Certifique-se de parar de passar os veículos!"
	},
    {
	...
	},
    {
	  ...
	  msg = "Tempo para entrar na estrada, assista a sua velocidade e não choque!",
	  area = 3
	},
    {
	...
	},
    {
	  ...
	  msg = "Entrando na cidade, assista sua velocidade!"
	},
    {
