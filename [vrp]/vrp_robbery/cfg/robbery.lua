...
cfg.robbery = { -- list of robberies
	...
	["paleto_twentyfourseven"] = { 
	  ...
	  dist = 15.0, rob = 400, wait = 900,	cops = 3, stars = 2, min = 10000, max = 20000
	},
	...
	["rockford_jewlery"] = { 
	  ...
	  dist = 15.0, rob = 700, wait = 900, cops = 3, stars = 2, min = 10000, max = 20000
	},
				--[[ BANKS ]]--
	["fleeca"] = { 
	  name = "Fleeca Bank",  
	  pos = {147.04908752441, -1044.9448242188, 29.36802482605}, 
	  dist = 15.0, rob = 700, wait = 1600, cops = 4, stars = 2, min = 20000, max = 40000
	},
	["fleeca2"] = { 
