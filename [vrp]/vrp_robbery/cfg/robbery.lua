...
cfg.robbery = { -- list of robberies
	...
	["paleto_twentyfourseven"] = { 
	  ...
	  dist = 15.0, rob = 120,	wait = 300,	cops = 2, stars = 2, min = 2000, max = 8000
	},
	["sandyshores_twentyfoursever"] = { 
	  name = "Twenty Four Seven. (Sandy Shores)", 
	  pos = {1960.7580566406, 3749.26367187, 31.3437423706055},
	  dist = 15.0, rob = 120, wait = 300, cops = 2, stars = 2, min = 3000, max = 8000
	},
	--[[["bar_one"] = { 
	...
	["eastlossantos_gasstop"] = { 
	  ...
	  dist = 15.0, rob = 120, wait = 300, cops = 2, stars = 2, min = 3000, max = 11000
	},
	--[[["tongva_gasstop"] = { 
	...
	["rockford_jewlery"] = { 
	  ...
	  dist = 15.0, rob = 300, wait = 600, cops = 2, stars = 2, min = 5000, max = 12000
	},
				--[[ BANKS ]]--
	["fleeca"] = { 
	  name = "Fleeca Bank",  
	  pos = {147.04908752441, -1044.9448242188, 29.36802482605}, 
	  dist = 15.0, rob = 300, wait = 600, cops = 3, stars = 2, min = 5000, max = 12000
	},
	["fleeca2"] = { 
	...
	--[[ ["fleeca3"] = { 
	  ...
	  dist = 15.0, rob = 300, wait = 600, cops = 3, stars = 2, min = 80000, max = 120000
	}, ]]
	--[[["fleeca4"] = { 
	...
	["fleeca6"] = { 
	  ...
	  dist = 15.0, rob = 300, wait = 600, cops = 3, stars = 2, min = 8000, max = 12000
	},
	["pacific"] = { 
	  name = "Pacific Standard PDB (Downtown Vinewood)", 
	  pos = {255.001098632813, 225.855895996094, 101.005694274902}, 
	  dist = 15.0, rob = 300, wait = 600, cops = 3, stars = 2, min = 8000, max = 17000
	},
				--[[ MORE ]]--
